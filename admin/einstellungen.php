...
<form method="post" class="admin-form" style="max-width:640px">
  ...
  <div class="admin-section">
    ...
    <p style="font-size:.82rem;color:#8a8a95;margin:.6rem 0 0">Sicherheitsmodus, Zugangscode und IP-Freischaltung findest du unter
      <a href="<?= url('/admin/sicherheit.php') ?>" style="color:#7e8bb8">Sicherheit</a>.</p>
  </div>
